<template>
	<Teleport to="body">
		<div v-if="isVisible" class="modal-container" :class="{ 'is-closing': isClosing }" :style="{ transform: `translateY(${offsetY}px)` }" @animationend="onAnimationEnd">
			<div class="bar-container" @touchstart="onTouchStart" @touchmove="onTouchMove" @touchend="onTouchEnd" @click="closeModal">
				<div class="bar" />
			</div>
			<div class="header">
