<template>
    <div class="counter-container">
        <div class="minus-button" @mousedown="startDecrement" @mouseup="stopInterval" @mouseleave="stopInterval"
            @click="decrement" @touchstart="startDecrement" @touchend="stopInterval">
            <img :src="MINUS" alt="Minus Button">
        </div>
        <div class="counter" :key="number">{{ formattedNumber }}</div>
        <div class="plus-button" @mousedown="startIncrement" @mouseup="stopInterval" @mouseleave="stopInterval"
            @click="increment" @touchstart="startIncrement" @touchend="stopInterval">
