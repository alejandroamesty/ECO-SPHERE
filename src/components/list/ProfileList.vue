<template>
    <div class="profile-list-container">
        <Profile v-for="(profile, index) in profiles" :key="index" :icon="profile.icon" :name="profile.name"
            :username="profile.username" :checked="profile.checked"
            @update:checked="(value) => handleCheckedChange(index, value)" />
    </div>
</template>
